            ...
            <div className="space-y-5">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 pt-1">
                  ...
                  >
                    ...
                    <span className="text-[9px] font-semibold opacity-70 text-zinc-550">
              ...
              <div className="bg-zinc-900/50 border border-red-900/20 rounded-3xl p-4 space-y-3">
                ...
                <p className="text-[10px] text-zinc-500 leading-relaxed">
                  Jika Bandar telat menekan Kunci Taruhan dan wasit sudah memutuskan, tekan tombol di bawah. Jika 3+ petaruh menekan, pasar otomatis dikunci.
                </p>
